...
var model = {
	...
	generateShip: function() {
		...
		if (direction === 1) {  //plaatsen het horizontaal
			row = Math.floor(Math.random() * this.boardSize);
			col = Math.floor(Math.random() * (this.boardSize - this.shipLength));
		} else { //verticaal rangschikken
...
function init() {
	...
	view.displayMessage("Hello, let's play! There are 6 ships, each 3 cells long");
}
